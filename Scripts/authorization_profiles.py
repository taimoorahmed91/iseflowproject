...
print("Fetching authorization profiles from ERS API...")

conn.request("GET", "/ers/config/authorizationprofile", headers=headers)
...
# Save to file
output_file = f"{OUTPUT_DIR}/authorization_profiles.json"
with open(output_file, 'w') as f:
    json.dump(json_data, f, indent=2)

print(f"✓ Saved authorization profiles to {output_file}")
...
if 'SearchResult' in json_data and 'resources' in json_data['SearchResult']:
    ...
    print(f"  Total authorization profiles found: {resource_count}")
