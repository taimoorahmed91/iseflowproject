...
print("Fetching allowed protocols from ERS API...")

conn.request("GET", "/ers/config/allowedprotocols", headers=headers)
...
# Save to file
output_file = f"{OUTPUT_DIR}/allowed_protocols.json"
with open(output_file, 'w') as f:
    json.dump(json_data, f, indent=2)

print(f"✓ Saved allowed protocols to {output_file}")
...
if 'SearchResult' in json_data and 'resources' in json_data['SearchResult']:
    ...
    print(f"  Total allowed protocols found: {resource_count}")
